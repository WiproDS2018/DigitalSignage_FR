...
var ProvisioningServiceClient = (function () {
    ...
    ProvisioningServiceClient.prototype.runBulkEnrollmentOperation = function (bulkEnrollmentOperation, callback) {
        ...
        var path = this._enrollmentsPrefix + this._versionQueryString();
        var httpHeaders = {
        ...
        this._restApiClient.executeApiCall('POST', path, httpHeaders, bulkEnrollmentOperation, function (err, bulkEnrollmentOperationResult, httpResponse) {
            if (callback) {
                if (err) {
                    callback(err);
                }
